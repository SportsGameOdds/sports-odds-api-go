...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Events.Get(context.Background(), sportsoddsapi.EventGetParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Events.Get(cancelCtx, sportsoddsapi.EventGetParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Events.Get(deadlineCtx, sportsoddsapi.EventGetParams{})
		if err == nil {
