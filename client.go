...
// interacting with the SportsGameOdds API. You should not instantiate this client
...
// environment (SPORTS_ODDS_API_KEY_HEADER, SPORTS_ODDS_API_KEY_HEADER,
// SPORTS_GAME_ODDS_BASE_URL). The option passed in as arguments are applied after
