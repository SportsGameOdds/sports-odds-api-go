...
// RequestOption is an option for the requests made by the SportsGameOdds API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/sports-odds-api-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.sportsgameodds.com/v2/")
}
...
// WithAPIKeyParam returns a RequestOption that sets the client setting "api_key_param".
func WithAPIKeyParam(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.APIKeyParam = value
		return r.Apply(WithQuery("apiKey", r.APIKeyParam))
	})
}
